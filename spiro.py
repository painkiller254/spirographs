...
OBJECTIVES
------------
create graphics with the turtlr module
Use parametri equations
...
# Pillow - Python Imaging library - saves images
...
class Spiro:
    ...
    def restart(self):
        ...
        self.t.setpos(self.sc + x, self.yc + y)
        self.t.sown()
...
class SpiroAnimator:
    # constructor
    def __init__(self, N):
        # set the timer calue in milliseconds
        self.deltaT = 10
...
def saveDrawing():
    ...
    # use the Pillow module to convert the poscript image fille to PNG
